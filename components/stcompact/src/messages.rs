...
use app::common::{
    Currency, HashResult, HashedLock, InvoiceId, MultiRoute, NamedIndexServerAddress,
    NamedRelayAddress, PaymentId, PlainLock, PublicKey, RandValue, Rate, Receipt, RelayAddress,
    Signature, Uid,
};
...
pub enum OpenPaymentStatus {
    ...
    Commit(app::common::Commit, u128), // (commit, fees)
    Success(Receipt, u128, Uid),       // (Receipt, fees, ack_uid)
    Failure(Uid),                      // ack_uid
}
