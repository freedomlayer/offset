...
that it might take some time until the payment destination E will be able to
collect his credits.
...
generated by the payment source (buyer) by generating a random `srcPlainLock`
value and hashing it: `srcHashedLock := sha512/256(srcPlainLock)`. This
mechanism is used to ensure transaction atomicity: The payment destination
...
hashing a secret generated by the payment destination: `destHashedLock :=
