...
the seller node, only the seller node may issue a cancellation message.
...
message was sent, only the seller node may send a Cancel message. After the
Commit message was sent, the transaction can not be cancelled.
